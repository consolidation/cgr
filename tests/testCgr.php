...
EOT;
     ...
     */
    public function testEnvironmentVariableSetting()
    {
        $argv = array(
            'cgr',
            '--composer-path',
...
EOT;
    ...
    /**
     * Functional test using a mocked application: we call 'echo' in
     * place of composer and see if the output looks correct.
     */
